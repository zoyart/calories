...
@section('content')
    <div class="content m-5 w-100">
        ...
        <form method="post" action="" id="create">
            ...
            <div class="row mb-5">
                <div class="col">
                    ...
                    <input class="form-control" type="number" placeholder="Protein" aria-label="protein"
                           name="protein" id="protein">
                </div>
                <div class="col">
                    <label for="fats" class="form-label">Fats</label>
                    <input class="form-control" type="number" placeholder="Fats" aria-label="fats"
                           name="fats" id="fats">
                </div>
                <div class="col">
                    <label for="carbohydrates" class="form-label">Carbohydrates</label>
                    <input class="form-control" type="number" placeholder="Carbohydrates" aria-label="carbohydrates"
        ...
        <div class="d-flex">
            <button form="create" type="submit" class="btn btn-outline-success">Create</button>
            <div class="mx-3">
                <input type="checkbox" class="form-check-input" id="save_as_draft">
